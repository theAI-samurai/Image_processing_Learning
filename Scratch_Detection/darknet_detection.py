...
lib = CDLL("D:/cloned_repos/Image_processing_Learning/Scratch_Detection/yolo_cpp_dll_no_gpu.dll", RTLD_GLOBAL)
...
class ObjectDetection:
    ...
    def detect(self, image_path, thresh=.5, hier_thresh=.7, nms=.45):
        im = load_image(image_path.encode('ascii'), 0, 0)                        # LOADS IMAGE IN MEMORY --image.c
        pnum = pointer(c_int(0))
