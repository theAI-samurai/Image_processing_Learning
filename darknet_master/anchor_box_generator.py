'''**************************************************
* this script generates anchor boxes based on the
* input images provided to it
* Running the script..
* $ python3 anchor_box_generator.py backup/train.txt
***************************************************'''
...
if "__main__" == __name__:
    ...
    parser.add_argument('--num_clusters', '-n', default=1, type=int, help='Number of Clusters')
    parser.add_argument('--output', '-o',
                        default='/home/ankit/Downloads/gitWork/Image_processing_Learning/'
                                'darknet_master/backup/anchor.txt',
                        type=str, help='Result Output File')
